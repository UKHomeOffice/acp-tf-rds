...
| <a name="input_iops"></a> [iops](#input\_iops) | The amount of provisioned IOPS. Setting this implies a storage\_type of `gp3`. See `notes` for limitations regarding this variable for `gp3` | `number` | `null` | no |
