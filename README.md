...
| auto_minor_version_upgrade | Allow automated minor version upgrade | string | `false` | no |
...
| deletion_protection | If true, enforces deletion protection - should set true on production | string | `false` | no |
...
| publicly_accessible | If true, the RDS will be publicly accessible | string | `false` | no |
